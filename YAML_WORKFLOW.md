...
### Momentum Benefit: {{ calling.momentum_benefit.name }}
- **Trigger:** {{ calling.momentum_benefit.trigger }}
- **Effect:** {{ calling.momentum_benefit.effect }}
{% endfor %}
```
...
_This workflow enables rapid iteration on game mechanics while maintaining a clear, maintainable codebase._
