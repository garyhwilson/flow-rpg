...
Magic in Autumn Phoenix RPG represents one of the most revolutionary aspects of the system: a unified casting framework where spells adapt to the caster's approach rather than being locked to a single tradition. This modular documentation covers the complete spell system, from basic cantrips to legendary master spells.

## Core Magic Philosophy

### The Momentum of Magic

Magic is fundamentally tied to the Momentum that permeates reality. Spellcasters learn to channel this Momentum through various approaches, shaping it according to their own strengths and perspectives. Unlike traditional magic systems where each caster type has unique spells, here the same spells can be cast through different mental and spiritual approaches, creating diverse effects.
...
- Successfully casting a cantrip generates +1 Momentum
...
## Spells and Momentum Generation

Spellcasters generate Momentum through multiple methods, ensuring they participate actively in the Momentum economy:

**Cantrips Generate Momentum:**

- Successfully casting any cantrip generates +1 Momentum
- This makes cantrips excellent for building momentum
- No Momentum cost means you're always gaining when successful

**Aggressive Stance:**

- When you successfully cast an offensive spell that deals damage, gain +1 Momentum
- Applies to all damage-dealing spells (Spark, Bolt, Fireball, etc.)
- Combines with cantrip Momentum generation for Spark

**Taking Damage:**

- When you take damage (regardless of armor), gain +1 Momentum
- Helps spellcasters recover from being targeted
- Universal Momentum generation for all character types

**Critical Success:**

- Rolling 13+ on any casting roll generates +1 Momentum
- Rewards high-skill casting

**Example Momentum Economy:** A wizard casts Spark (cantrip) in Aggressive Stance and hits. They gain +1 Momentum from cantrip success and +1 Momentum from Aggressive successful attack, for a total of +2 Momentum. Later, they cast Fireball (-1 Momentum) and hit, spending 1 Momentum but gaining 1 Momentum back from Aggressive, for net 0 Momentum cost.
...
The spell system adheres to Autumn Phoenix RPG's core design principles:
...
3. **Momentum as Universal Resource** - Magic fully integrated into the Momentum economy
4. **Player Agency** - Choose how to cast each spell based on the situation

---

_This spell system represents the flexible, narrative-driven approach to magic that defines Autumn Phoenix RPG. Every casting choice creates a unique story while maintaining mechanical clarity and balance._
