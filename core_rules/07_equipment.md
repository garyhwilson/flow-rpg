...
Weapons are categorized by type, with each category offering different advantages and trade-offs. Characters can use any weapon, though some archetypes have natural affinities for certain types.
...
- **Best For:** Ranged specialists, support characters, hunters
...
Armor provides damage reduction but may impose penalties on certain actions. The right armor choice depends on your character's role and attributes.
...
1. When hit by an attack, subtract your armor's damage reduction from the damage
2. Apply remaining damage to Guard first, then to Vitality when Guard is depleted
3. Damage reduction applies to all damage types unless specified otherwise

### Species Interactions with Armor

- **Dwarves:** Stone Endurance works with any armor, providing layered protection
- **Elves:** Elven Focus ignores the first point of armor penalty when casting spells
- **Halflings:** Small frame has no special armor interactions
- **Humans:** Adaptable trait allows for better adjustment to armor limitations

---

## Adventuring Gear

Beyond weapons and armor, characters need equipment for exploration, survival, and problem-solving. Each character starts with basic gear related to their archetype and can purchase additional items.
...
- **Torches (10):** 1 silver piece
- **Lantern:** 5 silver pieces
- **Oil (Flask):** 1 silver piece
- **Backpack:** 2 silver pieces
- **Bedroll:** 1 silver piece
- **Tent:** 5 silver pieces
...
- **Fishing Kit:** 2 silver pieces
- **Hunting Trap:** 5 silver pieces
- **Mess Kit:** 2 silver pieces
- **Winter Blanket:** 2 silver pieces
- **Survival Kit:** 10 silver pieces
- **Healer's Kit:** 5 silver pieces
...
- **Disguise Kit:** 10 silver pieces
- **Musical Instrument:** 5-25 silver pieces
- **Signet Ring:** 5 silver pieces
- **Perfume:** 5 silver pieces
- **Ink and Quill:** 5 silver pieces
- **Parchment (10 sheets):** 2 silver pieces
...
- **Smith's Tools:** 20 silver pieces
- **Artisan's Tools:** 15 silver pieces
- **Navigator's Tools:** 15 silver pieces
- **Tinker's Tools:** 10 silver pieces
- **Forgery Kit:** 15 silver pieces
- **Poisoner's Kit:** 20 silver pieces
- **Cartographer's Tools:** 15 silver pieces
...
- **Bird Call Whistle:** 2 silver pieces
...
- **Order Insignia:** 5 silver pieces
...
- **Grappling Hook (collapsible):** 5 silver pieces
...
- **Voice Soothing Tonic:** 5 silver pieces
- **Performance Makeup:** 2 silver pieces
...
The standard currency is the silver piece (sp), with other denominations available:

- **Copper Penny (cp):** 1/10 of a silver piece (common for everyday purchases)
- **Silver Piece (sp):** Standard unit of currency
- **Gold Mark (gm):** Worth 10 silver pieces (used for valuable items)
- **Platinum Crown (pc):** Worth 100 silver pieces (rare, used for major transactions)

### Starting Wealth

Characters begin with funds based on their background and archetype:

- **Base Wealth:** 3d6 × 10 silver pieces (average 105 sp)
- **Plus Archetype Equipment:** As listed in Archetype descriptions

### Lifestyle Expenses

Between adventures, characters pay living expenses:

- **Destitute:** Free (sleeping rough, foraging for food)
- **Poor:** 1 sp per day (shared room, basic meals)
- **Modest:** 2 sp per day (private room, decent meals)
- **Comfortable:** 5 sp per day (good accommodations, quality food)
- **Wealthy:** 10 sp per day (excellent lodging, fine dining)
- **Aristocratic:** 25+ sp per day (luxurious lifestyle)

### Services

Common services adventurers might require:

- **Meal, poor quality:** 0.5 sp
- **Meal, good quality:** 1 sp
- **Meal, excellent quality:** 3 sp
- **Inn stay, poor:** 1 sp per night
- **Inn stay, moderate:** 2 sp per night
- **Inn stay, good:** 5 sp per night
- **Messenger, local:** 0.5 sp
- **Messenger, distant city:** 5 sp
- **Carriage ride, within city:** 0.5 sp
- **Coach travel, between cities:** 3 sp per day
- **Ship passage:** 5 sp per day
- **Hiring a guard:** 3 sp per day
- **Hiring a guide:** 2 sp per day
- **Healing services:** 5-20 sp (depending on severity)
- **Legal services:** 10-50 sp (depending on complexity)

---

## Magical Items

While magical items are detailed further in the Magic Compendium, here are some common types characters might encounter:
...
- **Serrated:** Wounds bleed for 1 damage per round (20 sp)
- **Concealed:** Weapon can be hidden more easily (15 sp)
- **Linked:** Attached to chain/rope, can be retrieved as free action (10 sp)
...
- **Silent:** Advantage on Stealth checks (20 sp)
- **Quick-Release:** Can be removed in one action (15 sp)
