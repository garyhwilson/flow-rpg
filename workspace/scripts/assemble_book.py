...
Usage:
    ...
    python assemble_book.py publications/manifests/example_book.yaml
"""
...
class BookAssembler:
    ...
    def _include_directory(self, pattern: str, sort: str = 'alphabetical'):
        ...
        Args:
            pattern: Glob pattern (e.g., "content_modules/content_types/*.md")
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("\nExample:")
        print("  python assemble_book.py publications/manifests/example_book.yaml")
        sys.exit(1)
